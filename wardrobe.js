...
function draw(){
    ...
    if(Status != ""){
        objectDetector5.detect(pic, gotResult);
        for(i= 0; i< objects1.length; i++){
            ...
            document.getElementById("objects").innerHTML= "There are 3 big objects in the image and the cocossd model has detected " + objects1.length;
            console.log("Drawn!");
        }
    }
}
